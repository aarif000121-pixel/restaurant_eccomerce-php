...
<h3 align="center">Display All Orders</h3>
...
if($total != 0){
    ...
    while($result = mysqli_fetch_assoc($data)){
        ...
        <a href='order_status.php?id=".$result['id']."'>
        <input type='submit' value='Status' class='delete_btn'  name='status_btn'
         style='background-color: #05f977; color: white; border: none; padding: 5px 10px; ; text-decoration: none; display: inline-block; font-size: 16px; margin: -2px 1px; cursor: pointer;'></td>
         </a>
